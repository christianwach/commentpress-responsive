...
<?php if ( have_posts() ) {
	...
	<h3 class="author_pages_heading"><?php 
		...
		// show title
		echo apply_filters( 'cp_author_page_posts_list_title', __( 'Posts written by', 'commentpress-theme' ) ); 
...
if ( $_pages->have_posts() ) {
	...
	<h3 class="author_pages_heading"><?php 
		...
		// show title
		echo apply_filters( 'cp_author_page_pages_list_title', __( 'Pages written by', 'commentpress-theme' ) ); 
